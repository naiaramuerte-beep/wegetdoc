...
export default function BlogPost() {
  ...
  useEffect(() => {
    ...
    const url = `https://editpdf.online/blog/${post.slug}`;

    document.title = `${title} | editPDF Blog`;
    ...
    setMeta("og:site_name", "editPDF", true);
    ...
    const jsonLd = {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://editpdf.online/favicon.ico"
        }
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
