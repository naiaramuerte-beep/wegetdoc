  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* Article header */}
        <header className="py-12 md:py-16 border-b border-border" style={{ background: "linear-gradient(135deg, #C82F3B 0%, #E63946 100%)" }}>
          <div className="container max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-4 flex-wrap">
              <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-red-500/20 text-red-300 capitalize">
                {post.category}
              </span>
        ...
        <div className="py-10 md:py-14">
          <div className="container max-w-3xl">
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, #C82F3B 0%, #E63946 100%)" }}
            >
