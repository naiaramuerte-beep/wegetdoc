...
export const AD_PAGES: AdPageDef[] = [
  {
    ...
    title:     { es: "Edita tu PDF online en segundos", en: "Edit", fr: "Modifier", de: "PDF online bearbeiten in Sekunden", pt: "Editar", it: "Modifica", nl: "Bewerk", pl: "Edytuj", ru: "Редактировать", zh: "编辑" },
  ...
  },
  {
    ...
    editorTool: "sign",
    title:     { es: "Firma tu PDF online", en: "Sign", fr: "Signer", de: "PDF online unterschreiben", pt: "Assinar", it: "Firma", nl: "Onderteken", pl: "Podpisz", ru: "Подписать", zh: "签署" },
    highlight: { es: "PDF online", en: "PDF Online", fr: "PDF en ligne", de: "PDF online", pt: "PDF Online", it: "PDF Online", nl: "PDF Online", pl: "PDF Online", ru: "PDF онлайн", zh: "PDF 在线" },
    subtitle:  { es: "Añade tu firma digital en segundos. Legal y seguro.", en: "Add your digital signature to any PDF document in seconds — no printing needed", fr: "Ajoutez votre signature numérique à tout document PDF en quelques secondes", de: "Digitale Signatur in Sekunden. Rechtssicher und sicher.", pt: "Adicione sua assinatura digital a qualquer PDF em segundos — sem imprimir", it: "Aggiungi la tua firma digitale a qualsiasi PDF in pochi secondi", nl: "Voeg uw digitale handtekening toe aan elk PDF-document in seconden", pl: "Dodaj swój podpis cyfrowy do dowolnego PDF w kilka sekund", ru: "Добавьте цифровую подпись к любому PDF за считанные секунды", zh: "几秒钟内为任何PDF文档添加数字签名" },
  ...
  },
  {
    ...
    title:     { es: "Convierte tu PDF online", en: "Convert", fr: "Convertir", de: "PDF online umwandeln", pt: "Converter", it: "Converti", nl: "Converteer", pl: "Konwertuj", ru: "Конвертировать", zh: "转换" },
    highlight: { es: "PDF online", en: "PDF Online", fr: "PDF en ligne", de: "PDF online", pt: "PDF Online", it: "PDF Online", nl: "PDF Online", pl: "PDF Online", ru: "PDF онлайн", zh: "PDF 在线" },
    subtitle:  { es: "PDF a Word, Excel o JPG en segundos. Rápido y seguro.", en: "Convert PDF to Word, Excel, JPG, PNG and more — or the other way around, all in your browser", fr: "Convertissez PDF en Word, Excel, JPG, PNG et plus — tout dans votre navigateur", de: "PDF in Word, Excel oder JPG in Sekunden. Schnell und sicher.", pt: "Converta PDF para Word, Excel, JPG, PNG e mais — tudo no navegador", it: "Converti PDF in Word, Excel, JPG, PNG e altro — tutto nel browser", nl: "Converteer PDF naar Word, Excel, JPG, PNG en meer — alles in uw browser", pl: "Konwertuj PDF do Word, Excel, JPG, PNG i więcej — wszystko w przeglądarce", ru: "Конвертируйте PDF в Word, Excel, JPG, PNG и другие форматы", zh: "将PDF转换为Word、Excel、JPG、PNG等格式" },
