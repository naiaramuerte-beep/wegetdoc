...
export default function Blog() {
  ...
  // SEO meta tags
  useEffect(() => {
    document.title = `Blog — ${brandName} | Guías, tutoriales y consejos sobre PDF`;
    ...
    setMeta("description", `Aprende a editar, convertir, firmar y proteger PDFs con nuestras guías paso a paso. Tutoriales para sacar el máximo partido a ${brandName}.`);
        ...
        <section className="py-16 md:py-20 text-center" style={{ background: "linear-gradient(135deg, #14532d 0%, #1B5E20 100%)" }}>
          <div className="container max-w-3xl">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-green-400 text-sm font-medium uppercase tracking-wider">Blog</span>
            </div>
