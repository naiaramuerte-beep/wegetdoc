...
export const AUTH_STRINGS: Record<string, AuthModalStrings> = {
  ...
  uk: {
    signupEyebrow: "Реєстрація", loginEyebrow: "Вхід", forgotEyebrow: "Забули пароль",
    signupSubtitle: "Редагуйте, підписуйте та зберігайте PDF за секунди.",
    welcomeTitle: "З поверненням!", welcomeSubtitle: "Увійдіть через соцмережі або заповніть дані.",
    resetTitle: "Скидання пароля", resetSubtitle: "Введіть e-mail і ми надішлемо посилання.",
    forgotQ: "Забули пароль?", clickHere: "Натисніть тут", sendReset: "Надіслати посилання", backToLogin: "Повернутися до входу",
    gdprPrefix: "Я прочитав і приймаю", gdprAnd: " та ", gdprSuffix: ". Даю згоду на обробку персональних даних відповідно до GDPR.",
    gdprRequired: "Необхідно прийняти Умови та Політику конфіденційності",
    gdprTooltip: "Прийміть Умови та Політику конфіденційності, щоб продовжити",
    createAccountSwitch: "Створити акаунт",
    termsLinkLabel: "Умови користування", privacyLinkLabel: "Політика конфіденційності",
    registerSuccess: "Акаунт створено!", registerError: "Помилка реєстрації",
    loginSuccess: "З поверненням!", loginError: "Невірний e-mail або пароль",
    forgotSent: "Якщо e-mail існує, ви отримаєте посилання", forgotError: "Помилка надсилання",
    paywallTitle: "Створіть акаунт", paywallSubtitle: "щоб завантажити документ",
  },
  zh: {
