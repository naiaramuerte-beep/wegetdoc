...
export const AUTH_STRINGS: Record<string, AuthModalStrings> = {
  es: {
    ...
    gdprPrefix: "Al registrarte, aceptas los", gdprAnd: " y la ", gdprSuffix: ". Autorizas el tratamiento de tus datos personales conforme al RGPD.",
  ...
  en: {
    ...
    gdprPrefix: "By signing up, you accept the", gdprAnd: " and the ", gdprSuffix: ". You authorize the processing of your personal data under the GDPR.",
  ...
  fr: {
    ...
    gdprPrefix: "En vous inscrivant, vous acceptez les", gdprAnd: " et la ", gdprSuffix: ". Vous autorisez le traitement de vos données personnelles conformément au RGPD.",
  ...
  de: {
    ...
    gdprPrefix: "Mit der Registrierung akzeptierst du die", gdprAnd: " und die ", gdprSuffix: ". Du stimmst der Verarbeitung deiner personenbezogenen Daten gemäß DSGVO zu.",
  ...
  pt: {
    ...
    gdprPrefix: "Ao registares-te, aceitas os", gdprAnd: " e a ", gdprSuffix: ". Autorizas o tratamento dos teus dados pessoais conforme o RGPD.",
  ...
  it: {
    ...
    gdprPrefix: "Registrandoti, accetti i", gdprAnd: " e la ", gdprSuffix: ". Autorizzi il trattamento dei tuoi dati personali ai sensi del GDPR.",
  ...
  nl: {
    ...
    gdprPrefix: "Door je te registreren accepteer je de", gdprAnd: " en het ", gdprSuffix: ". Je geeft toestemming voor de verwerking van je persoonsgegevens onder de AVG.",
  ...
  pl: {
    ...
    gdprPrefix: "Rejestrując się, akceptujesz", gdprAnd: " oraz ", gdprSuffix: ". Wyrażasz zgodę na przetwarzanie swoich danych osobowych zgodnie z RODO.",
  ...
  ru: {
    ...
    gdprPrefix: "Регистрируясь, вы принимаете", gdprAnd: " и ", gdprSuffix: ". Вы даёте согласие на обработку персональных данных в соответствии с GDPR.",
  ...
  zh: {
    ...
    gdprPrefix: "注册即表示您接受", gdprAnd: " 和 ", gdprSuffix: "。您授权根据《通用数据保护条例》(GDPR) 处理您的个人数据。",
