...
async function startServer() {
  ...
  app.use((_req, res, next) => {
    ...
    res.setHeader("Content-Security-Policy", [
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://www.gstatic.com https://translate.googleapis.com https://static.hotjar.com https://script.hotjar.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://www.gstatic.com https://translate.googleapis.com",
      "font-src 'self' data: blob: https://fonts.gstatic.com https://script.hotjar.com",
      "object-src 'none'",
      "base-uri 'self'",
      "frame-src 'self' blob: https://*.stripe.com https://www.googletagmanager.com https://vars.hotjar.com",
      "img-src 'self' data: blob: https://www.googletagmanager.com https://www.google.com https://script.hotjar.com",
      "connect-src 'self' data: blob: https://api.stripe.com https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://www.google.com https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com",
