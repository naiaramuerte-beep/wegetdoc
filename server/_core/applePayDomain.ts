/**
 * Apple Pay merchant domain verification file content.
 *
 * Provided by Sipay for editorpdf.net. Embedded as a string instead of read
 * from disk because Vite was not copying the .well-known/ dotfile path into
 * the build output, so file lookups in production were failing.
 *
 * If Sipay re-issues this file (cert rotation, domain change, etc.) update
 * the source file in client/public/.well-known/ AND this constant in the
 * same commit.
 */
export const APPLE_PAY_DOMAIN_FILE = `MIIQYAYJKoZIhvcNAQcCoIIQUTCCEE0CAQExCzAJBgUrDgMCGgUAMG8GCSqGSIb3DQEHAaBiBGB7
InRlYW1JZCI6IlhRTTlSNTc1TkciLCJkb21haW4iOiJlZGl0b3JwZGYubmV0IiwiZGF0ZUNyZWF0
ZWQiOiIyMDI2LTA2LTExLDEyOjE2OjU4IiwidmVyc2lvbiI6MX2ggg0_MIIENDCCAxygAwIBAgII
RiAtvANPj7YwDQYJKoZIhvcNAQELBQAwczEtMCsGA1UEAwwkQXBwbGUgaVBob25lIENlcnRpZmlj
YXRpb24gQXV0aG9yaXR5MSAwHgYDVQQLDBdDZXJ0aWZpY2F0aW9uIEF1dGhvcml0eTETMBEGA1UE
CgwKQXBwbGUgSW5jLjELMAkGA1UEBhMCVVMwHhcNMjYwMTI4MTk1NTUyWhcNMzAxMjMxMDAwMDAw
...
DwAwggEKAoIBAQC4AcYCp_otIKvORq0VWHMu6bw1ZeWsctkGWB0ZlzoDopAd56pBfev55ANeawni
qHSPD7NCM8VHndPThayLKmIubSxNjol6ygxT6d2kHm6lAmn8dugEbDg9LfKqM3WBI8uHCd7m2_96
mRKfnFKDcTFV-X6tOyV1UlPgMrNgYU4Zq3sERbyrV2sID5TOlTJEAluKrXIgwKpnOzLPN4dVRaOT
ouIecP-kb4IFhMGZPmnWancTCllBNFoRDaQuENmxxms_YVUgA0KjTkGK-TxF39WXBL9NKE18ELl-
bSw-sCN63WiWk2knWo6nuXQRgefBINv8nZtkyg8tzA2ZVDMDF759AgMBAAGjgeUwgeIwDAYDVR0T
...
KDAmMCSgIqAghh5odHRwOi8vY3JsLmFwcGxlLmNvbS9haXBjYS5jcmwwHQYDVR0OBBYEFDsUaBBP
Ji2O2gtJUBdtrmQ-_5YRMA4GA1UdDwEB_wQEAwIHgDAPBgkqhkiG92NkBjoEAgUAMA0GCSqGSIb3
DQEBCwUAA4IBAQA6QHipxWwLHI7g8f4SbTNOvm4P0lbOL74JNuK2aZFJsQqjfGgSQ1h6-WPH457r
B35ERpbwdaekfHoe_j3830L2vHOMs0DKUTnRQvPh94p91shnaj7zJMD1TcIcJ_c664Ve5u87Yxt8
SAayMIjDtwBZaPVA7YXPmBrh1tJiLUyVm9IuS-Qt6h3BgUSeajOBLhZL8ldQjQ7OCTaYFyA9_gTg
svyc0zpjpSL-04Aw4yJjD513QA6jbOLI5hq3WY01IdjynjedPEVN2jGGU6sekvFJYgAlsE4PDGIR
MOtidHD86ATZhlehXijT4uXaihh5FuRwwXmYuUOMz8cF394qcae_MIIERDCCAyygAwIBAgIIXGPK
...
A1UECgwKQXBwbGUgSW5jLjELMAkGA1UEBhMCVVMCCEYgLbwDT4-2MAkGBSsOAwIaBQCggdwwGAYJ
KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjYwNjExMTIxNjU4WjAjBgkq
hkiG9w0BCQQxFgQU4MnNWO5O8hmdRzVkp2-vQBQDy4owKQYJKoZIhvcNAQk0MRwwGjAJBgUrDgMC
...
AQUABIIBAEyaaHSpORPoQxkETfa5zGPa6hZIZte6VCcxHqsSiMmmtccqTT8YzaMhDiV5QUw1-xmL
h00Ocrs3_6vS2SpN1uBMr42a3qUAZnLqyo88HRkbJoxcyUWjL7gURcaKoAO3Ms6WXkEqQQZH8IjE
g5gw6IgKfjtAOq7pXm5Qwf2bdagL-hRiAlEeB9CDphqgVYC-CEXloMshBiSygKovmtEMFqQi_Uv2
jqPvIuNhSt_wane7Y6tbataxS43OTsLOU70LzWaujtHZlzIWOFLLA3O6K4iV_mtmu3tsMZ1SNGOU
0D7ZFZnqlDr1AhF1EzoYre7Fc3iSEIF0gYx1pfY0pd6Slr4
`;
