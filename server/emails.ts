...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #0f172a;">
  <div style="text-align: center; margin-bottom: 32px;">
    <h1 style="color: #E63946; font-size: 24px; margin: 0;">EditorPDF</h1>
  </div>
  ...
  <div style="text-align: center; margin: 24px 0;">
    <a href="${cancelUrl}" style="display: inline-block; background: #E63946; color: white; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">
