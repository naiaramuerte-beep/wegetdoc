...
<p>wegetdoc.com se proporciona "tal cual" y "segun disponibilidad". El Titular no garantiza que el servicio sea ininterrumpido, libre de errores o que satisfaga todas las expectativas del usuario.</p>
...
<ul>
  ...
  <li><strong>Sitio web:</strong> <a href="https://wegetdoc.com">wegetdoc.com</a></li>
</ul>
...
<p>El responsable del tratamiento de los datos personales recogidos a traves de <strong>wegetdoc.com</strong> es:</p>
<ul>
...
<p>wegetdoc.com utiliza cookies para el correcto funcionamiento del servicio. Para informacion detallada sobre las cookies empleadas, sus finalidades y como gestionarlas, consulte nuestra <a href="/legal/cookies">Politica de Cookies</a>.</p>
...
<p>wegetdoc.com utiliza unicamente cookies estrictamente necesarias para el funcionamiento de la plataforma y cookies de preferencias del usuario. No empleamos cookies de publicidad ni de seguimiento de terceros con fines publicitarios.</p>
...
<table>
  ...
  <tbody>
    <tr><td>session_token</td><td>wegetdoc.com</td><td>Mantener la sesion del usuario activa tras el inicio de sesion.</td><td>7 dias</td></tr>
    <tr><td>csrf_token</td><td>wegetdoc.com</td><td>Proteger los formularios frente a ataques de falsificacion de solicitudes (CSRF).</td><td>Sesion</td></tr>
...
<table>
  ...
  <tbody>
    <tr><td>lang</td><td>wegetdoc.com</td><td>Recordar el idioma seleccionado por el usuario.</td><td>1 ano</td></tr>
    <tr><td>theme</td><td>wegetdoc.com</td><td>Almacenar la preferencia de tema visual (claro u oscuro).</td><td>1 ano</td></tr>
    <tr><td>cookie_consent</td><td>wegetdoc.com</td><td>Registrar la aceptacion o rechazo de cookies por parte del usuario.</td><td>1 ano</td></tr>
  </tbody>
</table>
...
<p>Tenga en cuenta que la desactivacion de las cookies esenciales puede impedir el correcto funcionamiento de wegetdoc.com, incluyendo el inicio de sesion y el uso de las herramientas de edicion de PDF.</p>
...
<h2>6. Contacto</h2>
<p>Si tiene alguna pregunta sobre el uso de cookies en wegetdoc.com, puede escribirnos a:</p>
<ul>
  <li><strong>Correo electronico:</strong> <a href="mailto:morteapps@outlook.com">morteapps@outlook.com</a></li>
</ul>
<p><em>Ultima actualizacion: 1 de diciembre de 2025</em></p>
...
<ul>
  ...
  <li>Direccion de correo electronico asociada a su cuenta en wegetdoc.com.</li>
...
<ul>
  ...
  <li>Perdera el acceso a las funcionalidades de pago de wegetdoc.com.</li>
